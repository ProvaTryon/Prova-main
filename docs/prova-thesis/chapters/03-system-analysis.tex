...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/erd.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.6\textheight,keepaspectratio]{figures/classdiagram.png}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/seq-purchase.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/seq-tryon.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/seq-rag.png}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/seq-measurement.png}}
