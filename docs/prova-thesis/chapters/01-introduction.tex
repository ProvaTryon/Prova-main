...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{A custom Multiview Generation Architecture.} The core architecture of Prova-VTON is heavily inspired by the foundational multiview generation approach proposed by He et al. in VTON360~\cite{he2025vton360}. We successfully replicated this state-of-the-art architecture and custom-trained our models from scratch using the MVHumanNet dataset~\cite{zheng2024mvhumannet}, integrating it seamlessly into a production-ready e-commerce ecosystem.
...
\begin{itemize}[leftmargin=*]
    ...
    \item A 2D virtual try-on pipeline using a custom trained diffusion-based synthesis model (Prova-VTON) with single-view and multi-angle support.
    ...
    \item A custom multiview virtual try-on workflow powered by Prova-VTON.
\end{itemize}
